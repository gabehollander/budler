...
export default function About(props) {
    ...
    return (
        <Paper className={classes.container} elevation={3}>
            ...
            This website charts historical data for <a class={classes.link} href="https://en.wikipedia.org/wiki/Option_(finance)">stock options</a>.
            <br/><br/>
            ...
            <br/><br/>
            If you're looking for the prime rib, <a class={classes.link} href="https://www.cboe.com/">CBOE</a> runs the data racket.
            Needless to say, it is very expensive, depending on what you want.
            For example, a <a class={classes.link} href="https://datashop.cboe.com/option-trades-subscription">subscription</a> to a daily dump of tick level options data, on all symbols, is 6K billed annually.
            For <a class={classes.link} href="https://datashop.cboe.com/option-trades">all</a> tick level data since 2005, on all symbols, a <i>measly</i> 30K one time charge.
            <br/><br/>
